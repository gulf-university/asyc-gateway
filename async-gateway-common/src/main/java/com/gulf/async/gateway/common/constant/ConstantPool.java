 ...
 * under the License.
 */
package com.gulf.async.gateway.common.constant;

import com.google.common.base.Strings;
import com.google.common.collect.Maps;
import com.gulf.async.gateway.common.util.Preconditions;
...
public abstract class ConstantPool<T extends Constant<T>> {
    ...
    public T valueOf(Class<?> firstNameComponent, String secondNameComponent) {
        Preconditions.assertNotNull(firstNameComponent, "firstNameComponent");
        Preconditions.assertNotNull(secondNameComponent, "secondNameComponent");
    ...
    public T valueOf(String name) {
        Preconditions.assertTrue(!Strings.isNullOrEmpty(name), "empty name");
