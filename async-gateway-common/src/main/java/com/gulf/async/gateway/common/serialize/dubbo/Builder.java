...
import com.gulf.async.gateway.common.serialize.dubbo.bytecode.ClassGenerator;
import com.gulf.async.gateway.common.serialize.dubbo.io.CompactedObjectInputStream;
import com.gulf.async.gateway.common.serialize.dubbo.io.CompactedObjectOutputStream;
import com.gulf.async.gateway.common.serialize.dubbo.io.UnsafeByteArrayInputStream;
import com.gulf.async.gateway.common.serialize.dubbo.io.UnsafeByteArrayOutputStream;
import com.gulf.async.gateway.common.util.ClassHelper;
import com.gulf.async.gateway.common.util.IOUtils;
...
//	    if (cl.getName().startsWith("javax")) return true;
	...
	static final Builder<Serializable> SerializableBuilder = new Builder<Serializable>(){
		...
		public Serializable parseFrom(GenericObjectInput in) throws IOException
		{
			...
			catch(ClassNotFoundException e){ throw new IOException(StringUtil.toString(e)); }
		}
	};
